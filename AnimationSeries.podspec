#
#  Be sure to run `pod spec lint AnimationSeries.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "gearmamn06"
  # spec.authors            = { "gearmamn06" => "gearmamn06@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/gearmamn06"
