...
extension UIView {
    ...
    public func disappear(duration: TimeInterval, delay: TimeInterval = 0.0, options: UIView.AnimationOptions = [], _ complete: CompleteCallback? = nil) -> AnimationSeries {
        let anim = Disappear(self, params:  ViewAnimation.Parameter(duration, delay: delay, options: options), complete)
        return anim
    }
    
    
    /// view.alpha -> 0.0 with AnimationParameter
    public func disappear(_ params:  ViewAnimation.Parameter, _ complete: CompleteCallback? = nil) -> AnimationSeries {
    ...
    public func discolor(to: UIColor, duration: TimeInterval, delay: TimeInterval = 0.0, options: UIView.AnimationOptions = [], _ complete: CompleteCallback? = nil) -> AnimationSeries {
        let anim = Discolor(self, params:  ViewAnimation.Parameter(duration, delay: delay, options: options), color: to, complete: complete)
        return anim
    }
    
    /// change view background color with AnimationParameter
    public func discolor(to: UIColor, params:  ViewAnimation.Parameter, complete: CompleteCallback? = nil) -> AnimationSeries {
    ...
    public func move(position offset: CGPoint, duration: TimeInterval, delay: TimeInterval = 0.0, options: UIView.AnimationOptions = [], _ complete: CompleteCallback? = nil) -> AnimationSeries {
        let anim = Move(self, params:  ViewAnimation.Parameter(duration, delay: delay, options: options), destination: offset, complete: complete)
        return anim
    }
    
    
    /// translate view position with with AnimationParameter
    public func move(position offset: CGPoint, params:  ViewAnimation.Parameter, complete: CompleteCallback? = nil) -> AnimationSeries {
    ...
    public func rotate(degree: CGFloat, duration: TimeInterval, delay: TimeInterval = 0.0, options: UIView.AnimationOptions = [],  _ complete: CompleteCallback? = nil) -> AnimationSeries {
        let anim = Rotate(self, params:  ViewAnimation.Parameter(duration, delay: delay, options: options), degree: degree, complete: complete)
        return anim
    }
    
    
    /// change view rotation angle with AnimationParameter
    public func rotate(degree: CGFloat, params:  ViewAnimation.Parameter, complete: CompleteCallback? = nil) -> AnimationSeries {
    ...
    public func sizing(scale to: (CGFloat, CGFloat), duration: TimeInterval, delay: TimeInterval = 0.0, options: UIView.AnimationOptions = [], _ complete: CompleteCallback? = nil) -> AnimationSeries {
        let anim = Sizing(self, params:  ViewAnimation.Parameter(duration, delay: delay, options: options), scale: to, complete)
        return anim
    }
    
    
    /// change size of the view with AnimationParameter
    public func sizing(scale to: (CGFloat, CGFloat), params:  ViewAnimation.Parameter, complete: CompleteCallback? = nil) -> AnimationSeries {
